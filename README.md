...
```
* * * * * ubuntu bash /home/ubuntu/apps/2018/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|2018|tweet|`location`||
|2018|facebook|`location`||
|2018|email|`location`||
|2018|new-comment||
|2018|open-share-discuss||
|2018|close-share-discuss||
|2018|summary-copied||
|2018|featured-tweet-action|`action`|
|2018|featured-facebook-action|`action`|
